...
// Enhanced student store with latest Zustand v5 patterns
      ...
      (set, get) => ({
        ...
        addStudent: async (student) => {
          try {
            ...
            set({ error: `Failed to add student: ${errorMessage}` });
        ...
        updateStudent: async (id, updates) => {
          try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Unknown error occurred';
            set({ error: `Failed to update student: ${errorMessage}` });
        ...
        removeStudent: async (id) => {
          try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Unknown error occurred';
            set({ error: `Failed to remove student: ${errorMessage}` });
        ...
        getStudentByName: async (name: string) => {
          try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Unknown error occurred';
            set({ error: `Failed to find student by name: ${errorMessage}` });
        ...
        incrementAttempts: async (studentId) => {
          try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Unknown error occurred';
            set({ error: `Failed to increment attempts: ${errorMessage}` });
        ...
        loadStudents: async () => {
          try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Unknown error occurred';
            set({ error: `Failed to load students: ${errorMessage}` });
        ...
        loadStudent: async (id) => {
          try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Unknown error occurred';
            set({ error: `Failed to load student: ${errorMessage}` });
